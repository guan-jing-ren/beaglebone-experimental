...
enum class CM_MPU_CLKSTCTRL{
    CLKTRCTRL,CLKACTIVITY_MPU_CLK,RESERVED=-1,offset=0,reset=6
};
enum class CM_MPU_MPU_CLKCTRL{
MODULEMODE,RESERVED0,IDLEST,STBYST,RESERVED=-1,offset=4,reset=2
};

using CM_MPU_CLKSTCTRL_REG=offset_register<CM_MPU_CLKSTCTRL,2,1,29>;
using CM_MPU_MPU_CLKCTRL_REG=offset_register<CM_MPU_MPU_CLKCTRL,2,14,2,1,13>;

// AM335x Rev O 8.1.12.5 p.1347
enum class CM_CLKOUT_CTRL{
CLKOUT2SOURCE,CLKOUT2DIV,RESERVED0,CLKOUT2EN,RESERVED=-1,offset=0,reset=0
};
...
MODULEMODE,RESERVED0,IDLEST,RESERVED=-1,offset=0,reset=0x30002
};
enum class CM_RTC_CLKSTCTRL{
CLKTRCTRL,RESERVED0,CLKACTIVITY_L4_RTC_GCLK,CLKACTIVITY_RTC_32KCLK,RESERVED=-1,offset=4,reset=0x102
};

using CM_RTC_RTC_CLKCTRL_REG=offset_register<CM_RTC_RTC_CLKCTRL,2,14,2,14>;
...
CLKTRCTRL,RESERVED0,CLKACTIVITY_GFX_L3_GCLK,CLKACTIVITY_GFX_FCLK,RESERVED=-1,offset=0,reset=2
};
enum class CM_GFX_GFX_CLKCTRL{
MODULEMODE,RESERVED0,IDLEST,STBYST,RESERVED=-1,offset=4,reset=0x70000
};
enum class CM_GFX_L4LS_GFX_CLKSTCTRL{
CLKTRCTRL,RESERVED0,CLKACTIVITY_L4LS_GFX_GCLK,RESERVED=-1,offset=0xC,reset=0x102
};
enum class CM_GFX_MMUCFG_CLKCTRL{
MODULEMODE,RESERVED0,IDLEST,RESERVED=-1,offset=0x10,reset=0x30000
};
enum class CM_GFX_MMUDATA_CLKCTRL{
MODULEMODE,RESERVED0,IDLEST,RESERVED=-1,offset=0x14,reset=0x30000
};

using CM_GFX_L3_CLKSTCTRL_REG=offset_register<CM_GFX_L3_CLKSTCTRL,2,6,1,1,22>;
using CM_GFX_GFX_CLKCTRL_REG=offset_register<CM_GFX_GFX_CLKCTRL,2,14,2,1,13>;
using CM_GFX_L4LS_GFX_CLKSTCTRL_REG=offset_register<CM_GFX_L4LS_GFX_CLKSTCTRL,2,6,1,23>;
using CM_GFX_MMUCFG_CLKCTRL_REG=offset_register<CM_GFX_MMUCFG_CLKCTRL,2,14,2,14>;
using CM_GFX_MMUDATA_CLKCTRL_REG=offset_register<CM_GFX_MMUDATA_CLKCTRL,2,14,2,14>;

// AM335x Rev O 8.1.12.8 p.1356-1359
enum class CM_CEFUSE_CLKSTCTRL{
CLKTRCTRL,RESERVED0,CLKACTIVITY_L4_CEFUSE_GICLK,CLKACTIVITY_CUST_EFUSE_SYS_CLK,RESERVED=-1,offset=0,reset=2
};
enum class CM_CEFUSE_CEFUSE_CLKCTRL{
MODULEMODE,RESERVED0,IDLEST,RESERVED=-1,offset=0x20,reset=0x30000
};

using CM_CEFUSE_CLKSTCTRL_REG=offset_register<CM_CEFUSE_CLKSTCTRL,2,6,1,1,22>;
using CM_CEFUSE_CEFUSE_CLKCTRL_REG=offset_register<CM_CEFUSE_CEFUSE_CLKCTRL,2,14,2,14>;
