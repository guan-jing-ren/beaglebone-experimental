...
// AM335x Rev O 8.1.12.2 p.1269-1328
...
// AM335x Rev O 8.1.12.3 p.1330-1343
...
using CM_MPU_CLKSTCTRL_REG = offset_register<CM_MPU_CLKSTCTRL, 2, 1, 29>;
using CM_MPU_MPU_CLKCTRL_REG =
    offset_register<CM_MPU_MPU_CLKCTRL, 2, 14, 2, 1, 13>;

// AM335x Rev O 8.1.12.5 p.1347
enum class CM_CLKOUT_CTRL {
  CLKOUT2SOURCE,
  CLKOUT2DIV,
  RESERVED0,
  CLKOUT2EN,
...
using CM_CLKOUT_CTRL_REG = offset_register<CM_CLKOUT_CTRL, 3, 3, 1, 1, 24>;

// AM335x Rev O 8.1.12.6 p.1347-1350
enum class CM_RTC_RTC_CLKCTRL {
  MODULEMODE,
  RESERVED0,
  IDLEST,
  RESERVED = -1,
...
using CM_RTC_RTC_CLKCTRL_REG =
    offset_register<CM_RTC_RTC_CLKCTRL, 2, 14, 2, 14>;
using CM_RTC_CLKSTCTRL_REG = offset_register<CM_RTC_CLKSTCTRL, 2, 6, 1, 1, 22>;

// AM335x Rev O 8.1.12.7 p.1350-1356
enum class CM_GFX_L3_CLKSTCTRL {
  CLKTRCTRL,
  RESERVED0,
...
enum class CM_GFX_L4LS_GFX_CLKSTCTRL {
  CLKTRCTRL,
  RESERVED0,
...
enum class CM_GFX_MMUCFG_CLKCTRL {
  MODULEMODE,
  RESERVED0,
  IDLEST,
  RESERVED = -1,
...
enum class CM_GFX_MMUDATA_CLKCTRL {
  MODULEMODE,
  RESERVED0,
  IDLEST,
  RESERVED = -1,
...
using CM_GFX_L3_CLKSTCTRL_REG =
    offset_register<CM_GFX_L3_CLKSTCTRL, 2, 6, 1, 1, 22>;
using CM_GFX_GFX_CLKCTRL_REG =
    offset_register<CM_GFX_GFX_CLKCTRL, 2, 14, 2, 1, 13>;
using CM_GFX_L4LS_GFX_CLKSTCTRL_REG =
    offset_register<CM_GFX_L4LS_GFX_CLKSTCTRL, 2, 6, 1, 23>;
using CM_GFX_MMUCFG_CLKCTRL_REG =
    offset_register<CM_GFX_MMUCFG_CLKCTRL, 2, 14, 2, 14>;
using CM_GFX_MMUDATA_CLKCTRL_REG =
    offset_register<CM_GFX_MMUDATA_CLKCTRL, 2, 14, 2, 14>;

// AM335x Rev O 8.1.12.8 p.1356-1359
enum class CM_CEFUSE_CLKSTCTRL {
  CLKTRCTRL,
  RESERVED0,
...
enum class CM_CEFUSE_CEFUSE_CLKCTRL {
  MODULEMODE,
  RESERVED0,
  IDLEST,
  RESERVED = -1,
...
using CM_CEFUSE_CLKSTCTRL_REG =
    offset_register<CM_CEFUSE_CLKSTCTRL, 2, 6, 1, 1, 22>;
